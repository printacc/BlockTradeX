...
public class CrippledJavaScriptParser {
        ...
        if (jsExpr.isEmpty()) {
            ...
            if (start == '[') {
                ...
                if (!isDigit(start) && start != '-' && start != '+') {
                    Keyword[] var7 = keywords;
                    int var9 = var7.length;

                    for (int var10 = 0; var10 < var9; ++var10) {
                        Keyword keyword = var7[var10];
    ...
    static {
        keywords = new Keyword[]{new Keyword("null", null), new Keyword("true", Boolean.TRUE), new Keyword("false", Boolean.FALSE)};
    }
