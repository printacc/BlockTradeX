...
import cn.muses.trade.entity.QRewardActivitySetting;
import cn.muses.trade.entity.RewardActivitySetting;
import cn.muses.trade.service.RewardActivitySettingService;
...
public class RewardActivityRecordController extends BaseAdminController {
    ...
    public MessageResult pageQuery(PageModel pageModel,
        ...
        return MessageResult.success(all.toString());
    }
