package cn.muses.trade.controller.redenvelope;
...
import cn.muses.trade.service.RedEnvelopeDetailService;
import cn.muses.trade.service.RedEnvelopeService;
import cn.muses.trade.util.DateUtil;
import cn.muses.trade.util.GeneratorUtil;
...
//		RedEnvelope redEnvelope = redEnveloperService.finById(id);
...
//    }
    ...
    public MessageResult envelopeDetailList(@RequestParam(value = "envelopeId", defaultValue = "0") Long envelopeId,
        ...
        return success(detailList.toString());
    }
