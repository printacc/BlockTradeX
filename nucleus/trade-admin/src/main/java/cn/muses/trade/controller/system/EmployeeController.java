...
/**
    ...
    public MessageResult addAdmin(Admin admin,
        ...
        String password;
        if (admin.getId() != null) {
            Admin admin1 = adminService.getOne(admin.getId());
    ...
    public MessageResult findAllAdminUser(
        ...
        for (Admin admin : all.getContent()) {
            SysRole role = sysRoleService.getOne(admin.getRoleId());
