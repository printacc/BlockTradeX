package cn.muses.trade.controller.cms;
...
import cn.muses.trade.model.screen.SysAdvertiseScreen;
...
import static cn.muses.trade.entity.QSysAdvertise.sysAdvertise;
...
public class AdvertiseController extends BaseAdminController {
    ...
    public MessageResult findOne(@Valid SysAdvertise sysAdvertise, BindingResult bindingResult) {
        ...
        return success(sysAdvertiseService.save(sysAdvertise).toString());
    }
    ...
    public MessageResult findOne(@RequestParam(value = "serialNumber") String serialNumber) {
        SysAdvertise sysAdvertise = sysAdvertiseService.getOne(serialNumber);
        notNull(sysAdvertise, "validate serialNumber!");
        return success(sysAdvertise.toString());
    }
    ...
    public MessageResult update(@Valid SysAdvertise sysAdvertise, BindingResult bindingResult) {
        ...
        SysAdvertise one = sysAdvertiseService.getOne(sysAdvertise.getSerialNumber());
    ...
    public MessageResult toTop(@RequestParam("serialNum") String serialNum) {
        SysAdvertise advertise = sysAdvertiseService.getOne(serialNum);
