...
import cn.muses.trade.dto.MemberDTO;
...
import cn.muses.trade.event.MemberEvent;
import cn.muses.trade.model.screen.MemberScreen;
...
import static cn.muses.trade.constant.MemberLevelEnum.IDENTIFICATION;
import static cn.muses.trade.entity.QMember.member;
...
//        memberDTO.setList(list);
        return success(memberDTO.toString());
    }
