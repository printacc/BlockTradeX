package cn.muses.trade.controller.businessAuth;
...
import static cn.muses.trade.constant.CertifiedBusinessStatus.*;
import static cn.muses.trade.constant.CertifiedBusinessStatus.CANCEL_AUTH;
import static cn.muses.trade.constant.CertifiedBusinessStatus.NOT_CERTIFIED;
import static cn.muses.trade.constant.CertifiedBusinessStatus.RETURN_FAILED;
import static cn.muses.trade.constant.CertifiedBusinessStatus.RETURN_SUCCESS;
import static cn.muses.trade.constant.CertifiedBusinessStatus.VERIFIED;

@RestController
@RequestMapping("business/cancel-apply")
public class BusinessCancelApplyController  {
//public class BusinessCancelApplyController extends BaseController {
    ...
    public MessageResult pageQuery(
        ...
        for (BusinessCancelApply businessCancelApply : page.getContent()) {
            DepositRecord depositRecord = depositRecordService.getOne(businessCancelApply.getDepositRecordId());
