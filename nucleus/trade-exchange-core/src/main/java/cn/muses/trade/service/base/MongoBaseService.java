package cn.muses.trade.service.base;

import cn.muses.trade.dto.PageParam;
import cn.muses.trade.dto.Pagenation;
...
//            query.with(Sort.by(pageParam.getDirection(),pageParam.getOrders()));
        }
