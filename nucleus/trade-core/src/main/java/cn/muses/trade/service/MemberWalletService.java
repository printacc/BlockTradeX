...
import cn.muses.trade.dto.MemberWalletDTO;
...
//				smsProvider.sendCustomMessage(mRes.getMobilePhone(), "尊敬的用户：恭喜您充值"+ wallet.getCoin().getUnit() + "成功，充值数量为：" + amount.stripTrailingZeros().toPlainString());
    ...
    public MemberWallet getOneByCoinNameAndMemberId(String coinName, long memberId) {
        ...
        return null;
//        return memberWalletDao.findById(and);
    }
