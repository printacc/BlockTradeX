...
import cn.muses.trade.dao.MemberWalletDao;
import cn.muses.trade.dao.WithdrawDao;
...
import cn.muses.trade.vo.WithdrawVO;
...
public class WithdrawService extends BaseService<Withdraw> {
    ...
    public Withdraw getOne(Long id) {
    ...
    public Iterable<Withdraw> findAllOut(Predicate predicate) {
        return withdrawDao.findAll(predicate, Sort.by(Sort.Direction.DESC, "id"));
    }
